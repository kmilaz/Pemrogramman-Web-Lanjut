...
<head>
    ...
    <title>Food & Beverage - POS System</title>
...
<body class="bg-slate-900 text-slate-100 font-sans flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-slate-800 border-r border-slate-700 flex flex-col shrink-0">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('category.food-beverage') }}" class="flex items-center gap-3 p-3 bg-blue-600 rounded-xl font-bold shadow-lg shadow-blue-900/20">
    ...
    <main class="flex-1 flex flex-col bg-slate-900 overflow-y-auto">
        <header class="h-16 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md sticky top-0 z-30 flex items-center px-8">
            <h2 class="text-xl font-bold">Food & Beverage</h2>
        </header>

        <div class="p-8">
            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-6">
                <!-- Static Products -->
                <div class="bg-slate-800 p-4 rounded-3xl border border-slate-700 hover:border-blue-500 shadow-xl group cursor-pointer transition-all">
                    <div class="aspect-square bg-slate-900 rounded-2xl mb-4 flex items-center justify-center overflow-hidden">
                        <i class="fa-solid fa-water text-4xl text-blue-400 group-hover:scale-110 transition-transform"></i>
                    </div>
                    <p class="font-bold text-sm">Mineral Water 500ml</p>
                    <p class="text-blue-400 font-extrabold mt-1">$0.50</p>
                </div>
                <!-- More items -->
                <div class="bg-slate-800 p-4 rounded-3xl border border-slate-700 hover:border-blue-500 shadow-xl group cursor-pointer transition-all">
                    <div class="aspect-square bg-slate-900 rounded-2xl mb-4 flex items-center justify-center overflow-hidden">
                        <i class="fa-solid fa-mug-hot text-4xl text-orange-400 group-hover:scale-110 transition-transform"></i>
                    </div>
                    <p class="font-bold text-sm">Coffee Bean Roast</p>
                    <p class="text-blue-400 font-extrabold mt-1">$4.20</p>
                </div>
                <div class="bg-slate-800 p-4 rounded-3xl border border-slate-700 hover:border-blue-500 shadow-xl group cursor-pointer transition-all">
                    <div class="aspect-square bg-slate-900 rounded-2xl mb-4 flex items-center justify-center overflow-hidden">
                        <i class="fa-solid fa-burger text-4xl text-yellow-400 group-hover:scale-110 transition-transform"></i>
                    </div>
                    <p class="font-bold text-sm">Beef Burger</p>
                    <p class="text-blue-400 font-extrabold mt-1">$3.50</p>
                </div>
                <div class="bg-slate-800 p-4 rounded-3xl border border-slate-700 hover:border-blue-500 shadow-xl group cursor-pointer transition-all">
                    <div class="aspect-square bg-slate-900 rounded-2xl mb-4 flex items-center justify-center overflow-hidden">
                        <i class="fa-solid fa-cookie text-4xl text-amber-600 group-hover:scale-110 transition-transform"></i>
                    </div>
                    <p class="font-bold text-sm">Chocolate Cookie</p>
                    <p class="text-blue-400 font-extrabold mt-1">$1.20</p>
                </div>
            </div>
        </div>
    </main>
